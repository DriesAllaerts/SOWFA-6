...
namespace fv
{
    defineTypeNameAndDebug(diskBasedADM, 0);
...
void Foam::fv::diskBasedADM::checkData() const
{
...
Foam::fv::diskBasedADM::diskBasedADM
(
    const word& name,
...
void Foam::fv::diskBasedADM::addSup
(
    fvMatrix<vector>& eqn,
    const label fieldi
)
...
bool Foam::fv::diskBasedADM::read(const dictionary& dict)
{
